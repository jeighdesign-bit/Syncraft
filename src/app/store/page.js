...
const sections = [
  {
    ...
    description: "Practical automation tools made to speed up image enhancement, resizing, batch production, and print nesting.",
    itemLabel: "Sublimation Tool",
    products: [
      {
        name: "DesaynScale",
        description: "Upscale, sharpen, and enhance artwork with AI, including batch processing for faster production. Includes lifetime access.",
        price: "₱950",
        meta: "AI image upscaler · Lifetime",
        theme: "Lime",
        image: "/Store/Sublimation Tools/DesaynsCale (IMAGE UPSCALING) LIFETIME ACCESS.jpg",
      },
      {
